   ...
   return (
      <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-2">
         ...
         <CardFooter className="absolute bg-white/30 bottom-0 border-t-1 border-zinc-100/50 z-10 justify-between">
            <Button onClick={() => handleExternalRedirect(url)} className="text-tiny bg-lime-700 text-white font-bold" radius="sm" size="sm">
               Producción
            </Button>
            <Button className="text-tiny bg-gray-700 text-white font-bold" radius="sm" size="sm">
               Versión de Pruebas
            </Button>
         </CardFooter>
      </Card>
